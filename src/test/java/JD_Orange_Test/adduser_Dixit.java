...
public class adduser_Dixit {
...

	{
		...
		driver.findElementById("systemUser_userName").sendKeys("Priyanka");
		driver.findElementById("systemUser_password").sendKeys("Prayan@123");
		driver.findElementById("systemUser_confirmPassword").sendKeys("Prayan@123");
